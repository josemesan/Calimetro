...
import myapp.metro.es.CalimetroApp;
import myapp.metro.es.domain.Authority;
import myapp.metro.es.domain.User;
import myapp.metro.es.repository.AuthorityRepository;
...
import myapp.metro.es.web.rest.errors.ExceptionTranslator;
import myapp.metro.es.web.rest.vm.KeyAndPasswordVM;
import myapp.metro.es.web.rest.vm.ManagedUserVM;
