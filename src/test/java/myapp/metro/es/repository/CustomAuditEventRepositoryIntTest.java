package myapp.metro.es.repository;

import myapp.metro.es.CalimetroApp;
import myapp.metro.es.config.Constants;
import myapp.metro.es.config.audit.AuditEventConverter;
import myapp.metro.es.domain.PersistentAuditEvent;
...
import static myapp.metro.es.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
